...
export const PortfolioNav = () => {
  ...
  useEffect(() => {
    ...
    // Reset the active state when the component mounts
    setActive(false);
      ...
      <div className='header'>
        ...
        <nav className={active ? 'slider active' : 'slider'} ref={ref}>
          <div className='logoLx'>
            <img src={logo1} height={50} alt='logo' className='LogoImg' />
            <h2>Wishot</h2>
          </div>
          <ul>
            <li className='menu'>
              <div className='logo logoLi'>
            ...
            >
              <li className={activeLiLink === 'hero' ? 'activate' : ''}>Home</li>
            </ScrollLink>
            <ScrollLink
              ...
              className='scrollLink'
            >
              <li className={activeLiLink === 'about' ? 'activate' : ''}>About</li>
            </ScrollLink>
            <ScrollLink
              ...
              className='scrollLink'
            >
              <li className={activeLiLink === 'resume' ? 'activate' : ''}>Resume</li>
            </ScrollLink>
            <ScrollLink
              ...
              className='scrollLink'
            >
              <li className={activeLiLink === 'services' ? 'activate' : ''}>Services</li>
            </ScrollLink>
            <ScrollLink
              ...
              className='scrollLink'
            >
              <li className={activeLiLink === 'portfolio' ? 'activate' : ''}>Portfolio</li>
            </ScrollLink>
            <ScrollLink
              ...
              className='scrollLink'
            >
              <li className={activeLiLink === 'contact' ? 'activate' : ''}>Contact</li>
            </ScrollLink>
          </ul>
        </nav>
      </div>
